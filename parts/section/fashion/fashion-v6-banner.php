	...
	<div class="row">
		<div class="col-md-4 col-sm-6 col-xs-12 banner-1 wow fadeInUp" data-wow-delay="0.2s">
			<div class="banner-outer">
				<a href="#">
					<div class="image">
						<img src="assets/images/banners/10.jpg" class="img-responsive" alt="#">
					</div>
					<div class="text">
						<h4>new arrivals</h4>
						<h2>accessories</h2>
		...
		<div class="col-md-4 col-sm-6 col-xs-12 banner-2 wow fadeInUp" data-wow-delay="0.4s">
			<div class="banner-outer ">
				<a href="#">
					<div class="image">
					     <img src="assets/images/banners/11.jpg" alt="#" class="img-responsive">
					</div>
					<div class="text">
						<h4>new design</h4>
						<h2>fashion</h2>
		...
		<div class="col-md-4 col-sm-12 col-xs-12 banner-3 wow fadeInUp" data-wow-delay="0.6s">
			<div class="banner-outer">
				<a href="#">
					<div class="image">
					    <img src="assets/images/banners/12.jpg" alt="#" class="img-responsive">
					</div>
					<div class="text">
						<h4>fashion 2015</h4>
						<h2>lookbook</h2>
